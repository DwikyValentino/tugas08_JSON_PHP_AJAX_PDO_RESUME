...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Des 2019 pada 07.47
...
(4, 'Admin', ' bergabung dalam chat', '07:53'),
(5, 'Admin', ' bergabung dalam chat', '07:23'),
(13, 'Admin', ' bergabung dalam chat', '08:27');
...
--
ALTER TABLE `drzchat`
  MODIFY `nomor` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
COMMIT;
